      ...
      >
        <li className="mb-10 ms-4" role="listitem">
          ...
          <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
            A parent should learn sign language to enhance communication and
            foster a stronger connection with their specially-abled child,
            promoting inclusivity and understanding of their unique needs and
            experiences.
          </p>
        </li>
